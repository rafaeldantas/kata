...
The only dependency is Junit 4.11
It's a simple design,favoring immutability when possible.

To run the unit tests (requires maven)
mvn test

To build a executable jar (requires maven)
mvn package

to run the executable jar (already included)
java -jar target/mars-rovers-1.0-SNAPSHOT.jar

Manifest-Version: 1.0
Archiver-Version: Plexus Archiver
Created-By: Apache Maven
Built-By: rafaeldantas@gmail.com
Build-Jdk: 1.7.0_15
Main-Class: com.nokia.marsrovers.MissionController
